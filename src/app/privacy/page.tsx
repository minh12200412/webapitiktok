...
const sections = [
  {
    ...
    items: [
      ...
      "Video engagement metrics such as views, likes, comments, and shares",
      "Authorization scopes granted to the app",
      "Access and refresh token metadata",
      "Publish status and upload status",
      "Direct Post consent and privacy settings selected by the user",
      "Scheduled publishing metadata such as schedule time and schedule status",
  ...
  },
  {
    ...
    items: [
      ...
      "This app does not use TikTok Webhook or Share Kit in the current phase.",
    ],
  },
];
